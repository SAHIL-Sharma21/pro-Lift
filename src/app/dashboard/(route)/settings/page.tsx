...
export default function SettingsPage() {
    ...
    const handleAdminSettingsChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const handleToggleChange = (name: string) => {
        setSiteSettings(prev => ({ ...prev, [name]: !prev[name as keyof typeof siteSettings] }));
    };
                    ...
                    <TabsContent value="admin">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Manage your admin account details here.</CardDescription>
                            </CardHeader>
                    ...
                    <TabsContent value="site">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Manage general site settings here.</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="space-y-2">
                                ...
                                <div className="flex items-center space-x-2">
                                    <Switch
                                        ...
                                        onCheckedChange={() => handleToggleChange('enableRegistrations')}
                                    />
