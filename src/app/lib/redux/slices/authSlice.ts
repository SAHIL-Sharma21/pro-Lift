...
export const registerUser = createAsyncThunk(
  "auth/registerUser",
  async (userData: RegisterUserCredentials, { rejectWithValue }) => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URI}/users/register`,
        {
          method: "POST",
...
export const registerAdmin = createAsyncThunk(
  ...
  async (userData: RegisterUserCredentials, { rejectWithValue }) => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URI}/users/admin-register`,
        {
          method: "POST",
          headers: { "Content-type": "application/json" },
          body: JSON.stringify(userData),
...
export const loginUser = createAsyncThunk(
  "auth/loginUser",
  async (credentials: LoginUserCredentials, { rejectWithValue }) => {
    try {
      const response = await fetch(
  ...
  async (_, { rejectWithValue, getState }) => {
    try {
      ...
      if (state.auth.accessToken) {
        const data = await apiCallUsers({
          url: `${process.env.NEXT_PUBLIC_BACKEND_URI}/users/getUser`,
          method: "GET",
      ...
      return rejectWithValue(
        error instanceof Error ? error.message : "Failed to get logged in user"
      );
    }
  }
);
...
export const logoutUser = createAsyncThunk(
  ...
  async (_, { getState, rejectWithValue }) => {
    try {
      ...
      if (state.auth.accessToken) {
        const data = await apiCallUsers({
          url: `${process.env.NEXT_PUBLIC_BACKEND_URI}/users/logout`,
          method: "POST",
          token: state.auth.accessToken,
          body: undefined,
        });
...
export const googlLogin = createAsyncThunk(
  ...
  async (token: string, { rejectWithValue }) => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URI}/users/google-login`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
...
export const changePassword = createAsyncThunk(
  "auth/changePassword",
  async (payload: ChangePassword, { rejectWithValue, getState }) => {
    try {
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(registerUser.rejected, (state, action) => {
        state.loading = false;
        state.error =
          (action.error.message as string) || "Failed to register user";
      })
      ...
      .addCase(registerAdmin.rejected, (state, action) => {
        state.loading = false;
        state.error =
          (action.error.message as string) || "Failed to register admin";
      })
      ...
      .addCase(loginUser.rejected, (state, action) => {
        state.loading = false;
        state.error =
          (action.error.message as string) || "Failed to login user";
      })
      ...
      .addCase(logoutUser.rejected, (state, action) => {
        state.loading = false;
        state.error =
          (action.error.message as string) || "Failed to logout user";
      })
      ...
      .addCase(getLoggedInUser.rejected, (state, action) => {
        ...
        state.loading = false;
        state.error =
          (action.error.message as string) || "Failed to get logged in user";
      })
      ...
      .addCase(googlLogin.rejected, (state, action) => {
        state.loading = false;
        state.error =
          (action.error.message as string) || "Failed to login with google";
      })
