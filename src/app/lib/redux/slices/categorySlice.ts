...
export const updateCategory = createAsyncThunk(
  ...
  async (
    { payload, categoryId }: { payload: UpdateCategory; categoryId: string },
    { rejectWithValue }
  ) => {
    try {
      const response = await fetch(
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(addCategory.rejected, (state, action) => {
        state.loading = false;
        state.error =
          (action.error.message as string) || "Failed to create category";
      })
      ...
      .addCase(updateCategory.rejected, (state, action) => {
        state.loading = false;
        state.error =
          (action.error.message as string) || "Failed to update category";
      })
      ...
      .addCase(deleteCategory.rejected, (state, action) => {
        state.loading = false;
        state.error =
          (action.error.message as string) || "Failed to delete category";
      })
      ...
      .addCase(getAllCategories.rejected, (state, action) => {
        state.loading = false;
        state.error =
          (action.error.message as string) || "Failed to get all categories";
      })
      ...
      .addCase(getCategoryById.rejected, (state, action) => {
        state.loading = false;
        state.error =
          (action.error.message as string) || "Failed to get category by id";
      });
  },
});
